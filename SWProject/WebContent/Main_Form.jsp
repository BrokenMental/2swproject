...
<body>
	...
	%>
	<center>
		<table class="Main_table2" border="1px solid" width="95%"
			height="50px"
			style="border-color: white; border-collapse: collapse; margin: 7px; text-align: center; background: #F2DDDE;">
			<tr>
				<td width="60%"><a href="Memo_List.jsp?today=<%=today%>"><%=today%></a>
					<%
						if (year.equals(ye)) {
					%>
